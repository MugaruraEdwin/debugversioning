 let names = [{firstname:"Jamie"},{lastname:"Joeline"},{middlename:"Musumba"}];

 // To string - converts a whole arrsy to one string

//  let namesString = names.toString();

//  console.log(namesString.length)

 // Join - similat to toString joins with specifc  key word i.e. " and "

//  let joinNames = names.join(" and ");

//  console.log(joinNames)

 // Concat - combines arrays together, to add more within the concat parentheses (names2, names3)

//  let names1 = ['Catch', 'the', 'pigeon', 'duster'];
//  let names2 = ['the', 'flin', 'stones', 'rumble' ];

//   let joinConcat = names1.concat(names2);

//   console.log(joinConcat)

// Splice - mutats the original array

// let names3= ['Catch', 'the', 'pigeon', 'duster'];

// names3.splice(1,1); // Deletes from index 1 and stops deletion on index 1

// console.log(names3)

// names3.splice(1,0,"the");

// console.log(names3)

// let names3Copy = [...names3];// allows yoy make a copy and avoid the mutatiosn

// names3Copy.splice(1,2,"Bill","Bob"); // Deletes from index 1 amnd 2 and replaces them with Bill and Bob

// console.log(names3Copy)

// Slice - slices out parts of an array - DOESN'T INCLUDE THE LAST INDEX - doesn't mutate riginal array

// let name4Copy = [1,2,3,4,5,1];

// let sliceNames = name4Copy.slice(1,3);// will return items in indexes 1 and 2 leaving out index 3

// names4Copy.slice(1) // starts from index 1 returning values till the end of the array

// console.log(sliceNames)

// Indexof - finds index of a certain value in an array

// let index = name4Copy.indexOf(1);

// console.log(index)

// // LastiNDEXOF

// console.log(name4Copy.lastIndexOf(1))

// total sum for array elements 
// let sum  = 0;
// for(i = 0; i < name4Copy.length; i++ ){
//     sum += name4Copy[i]
// }
...
// fruits = ['apples', 'magoes', 'grapes', 'berries'];
